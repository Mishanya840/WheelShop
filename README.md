...
Главная страница
---------------------------
![Главная страница](image/readme/main.jpg)
...
Авторизация
---------------------------
![Главная страница](/public/image/readme/login.jpg)
![Главная страница](public/image/readme/registration.jpg)    На страницах регистрации и входи расположены простые формы.
